...
""",
    ...
    'data': [
        ...
        'report/pos_monthly_report_templates.xml',
        'report/pos_monthly_toc_templates.xml',
        'report/pos_monthly_channel_templates.xml',
        'report/pos_monthly_extra_actions.xml',
        'report/pos_monthly_report_action.xml',
        'report/pos_period_report_action.xml',
        'report/pos_sales_report_templates.xml',
        'wizard/pos_sales_report_wizard_views.xml',
        'wizard/pos_weekly_report_wizard_views.xml',
        'wizard/pos_monthly_report_wizard_views.xml',
        'wizard/pos_period_report_wizard_views.xml',
    ],
    'installable': True,
    'application': False,
}
