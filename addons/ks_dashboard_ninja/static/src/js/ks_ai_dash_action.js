...
import { user } from "@web/core/user";
    ...
    var // TODO: converted from AbstractAction
class KsAIDashboardNinja extends Component { constructor(props) { super(props); {
...
//            this.ksUpdateDashboardItem = this.ksUpdateDashboardItem.bind(this);
            ...
            if(state.context.ks_reload_menu){
                this.env.bus.trigger('reload_menu_data', { keep_open: true, scroll_to_bottom: true});
            }
            var context = {
...
//            });
    ...
    registry.category("actions").add('ks_dashboard_ninja_ai', KsAIDashboardNinja);